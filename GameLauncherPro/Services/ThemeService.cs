...
namespace GameLauncherPro.Services
{
    public static class ThemeService
    {
        private static readonly IReadOnlyDictionary<string, string> LightPalette = new Dictionary<string, string>
        {
            ...
            ["HeatmapEmptyBrush"] = "#E7EDF3",
            ["HeatmapLevel1Brush"] = "#B7DCE8",
            ["HeatmapLevel2Brush"] = "#72B9C7",
            ["HeatmapLevel3Brush"] = "#2E8998",
            ["HeatmapLevel4Brush"] = "#13616E",
        ...
        private static readonly IReadOnlyDictionary<string, string> DarkPalette = new Dictionary<string, string>
        {
            ...
            ["HeatmapEmptyBrush"] = "#203148",
            ["HeatmapLevel1Brush"] = "#214D62",
            ["HeatmapLevel2Brush"] = "#267185",
            ["HeatmapLevel3Brush"] = "#2199A4",
            ["HeatmapLevel4Brush"] = "#59C8C1",
